...
public final class Lens<T,F> extends Setter<T,F> implements Apply<T,F> {
    ...
    public static final <T> Lens<_39<T>,T> _39() {
        return new Lens<_39<T>, T>(new Apply<_39<T>, T>() {
            public T apply(_39<T> t) {
                return t.get_39();
            }
        }, new Function2<_39<T>, Apply<T,T>, _39<T>>() {
            @SuppressWarnings("unchecked")
            @Override
            public _39<T> apply(_39<T> t, Apply<T, T> f) {
                Object[] vs = ((Tuple)t).toArray();
    ...
    /**
     * @return lens targetting field 41 of a tuple.
     */
    public static final <T> Lens<_41<T>,T> _41() {
        return new Lens<_41<T>, T>(new Apply<_41<T>, T>() {
            public T apply(_41<T> t) {
                return t.get_41();
            }
        }, new Function2<_41<T>, Apply<T,T>, _41<T>>() {
            @SuppressWarnings("unchecked")
            @Override
            public _41<T> apply(_41<T> t, Apply<T, T> f) {
                Object[] vs = ((Tuple)t).toArray();
                vs[40] = f.apply(t.get_41());
                return (_41<T>) Tuple.of(vs);
            }
        });
    }
    
    /**
     * @return lens targetting field 42 of a tuple.
     */
    public static final <T> Lens<_42<T>,T> _42() {
        return new Lens<_42<T>, T>(new Apply<_42<T>, T>() {
            public T apply(_42<T> t) {
                return t.get_42();
            }
        }, new Function2<_42<T>, Apply<T,T>, _42<T>>() {
            @SuppressWarnings("unchecked")
            @Override
            public _42<T> apply(_42<T> t, Apply<T, T> f) {
                Object[] vs = ((Tuple)t).toArray();
                vs[41] = f.apply(t.get_42());
                return (_42<T>) Tuple.of(vs);
            }
        });
    }
    
    /**
     * @return lens targetting field 43 of a tuple.
     */
    public static final <T> Lens<_43<T>,T> _43() {
        return new Lens<_43<T>, T>(new Apply<_43<T>, T>() {
            public T apply(_43<T> t) {
                return t.get_43();
            }
        }, new Function2<_43<T>, Apply<T,T>, _43<T>>() {
            @SuppressWarnings("unchecked")
            @Override
            public _43<T> apply(_43<T> t, Apply<T, T> f) {
                Object[] vs = ((Tuple)t).toArray();
                vs[42] = f.apply(t.get_43());
                return (_43<T>) Tuple.of(vs);
            }
        });
    }
    
    /**
     * @return lens targetting field 44 of a tuple.
     */
    public static final <T> Lens<_44<T>,T> _44() {
        return new Lens<_44<T>, T>(new Apply<_44<T>, T>() {
            public T apply(_44<T> t) {
                return t.get_44();
            }
        }, new Function2<_44<T>, Apply<T,T>, _44<T>>() {
            @SuppressWarnings("unchecked")
            @Override
            public _44<T> apply(_44<T> t, Apply<T, T> f) {
                Object[] vs = ((Tuple)t).toArray();
                vs[43] = f.apply(t.get_44());
                return (_44<T>) Tuple.of(vs);
            }
        });
    }
}
