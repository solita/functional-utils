...
public abstract class Function3<T1, T2, T3, R> extends MultiParamFunction<Tuple3<T1,T2,T3>, R> {
    ...
    public final Function1<T1,R> apply(GivenLater _, final T2 t2, final T3 t3) {
    ...
    public final Function1<T2,R> apply(final T1 t1, GivenLater _, final T3 t3) {
    ...
    public final Function1<T3,R> apply(final T1 t1, final T2 t2, GivenLater _) {
    ...
    public final Function2<T1,T3,R> apply(GivenLater _1, final T2 t2, GivenLater _2) {
    ...
    public final Function2<T1,T2,R> apply(GivenLater _1, GivenLater _2, final T3 t3) {
