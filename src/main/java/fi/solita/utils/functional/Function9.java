...
public abstract class Function9<T1, T2, T3, T4, T5, T6, T7, T8, T9, R> extends MultiParamFunction<Tuple9<? extends T1, ? extends T2, ? extends T3, ? extends T4, ? extends T5, ? extends T6, ? extends T7, ? extends T8, ? extends T9>, R, T1> {
