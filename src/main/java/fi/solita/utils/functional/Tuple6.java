...
public class Tuple6<T1, T2, T3, T4, T5, T6> extends Tuple implements Tuple._1<T1>, Tuple._2<T2>, Tuple._3<T3>, Tuple._4<T4>, Tuple._5<T5>, Tuple._6<T6> {
    ...
    static final class SerializableTuple<T1 extends Serializable, T2 extends Serializable, T3 extends Serializable, T4 extends Serializable, T5 extends Serializable, T6 extends Serializable> extends Tuple6<T1, T2, T3, T4, T5, T6> implements Serializable {
        ...
        SerializableTuple(T1 _1, T2 _2, T3 _3, T4 _4, T5 _5, T6 _6) {
