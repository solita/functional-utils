...
public abstract class Function4<T1, T2, T3, T4, R> extends MultiParamFunction<Tuple4<T1, T2, T3, T4>, R> {
    ...
    public final Function1<T1,R> apply(GivenLater _, final T2 t2, final T3 t3, final T4 t4) {
    ...
    public final Function1<T2,R> apply(final T1 t1, GivenLater _, final T3 t3, final T4 t4) {
    ...
    public final Function1<T3,R> apply(final T1 t1, final T2 t2, GivenLater _, final T4 t4) {
    ...
    public final Function1<T4,R> apply(final T1 t1, final T2 t2, final T3 t3, GivenLater _) {
    ...
    public final Function2<T1,T2,R> apply(GivenLater _1, GivenLater _2, final T3 t3, final T4 t4) {
    ...
    public final Function2<T1,T3,R> apply(GivenLater _1, final T2 t2, GivenLater _2, final T4 t4) {
    ...
    public final Function2<T1,T4,R> apply(GivenLater _1, final T2 t2, final T3 t3, GivenLater _2) {
    ...
    public final Function2<T2,T4,R> apply(final T1 t1, GivenLater _1, final T3 t3, GivenLater _2) {
    ...
    public final Function2<T3,T4,R> apply(final T1 t1, final T2 t2, GivenLater _1, GivenLater _2) {
    ...
    public final Function3<T1,T2,T3,R> apply(GivenLater _1, GivenLater _2, GivenLater _3, final T4 t4) {
    ...
    public final Function3<T1,T2,T4,R> apply(GivenLater _1, GivenLater _2, final T3 t3, GivenLater _3) {
    ...
    public final Function3<T1,T3,T4,R> apply(GivenLater _1, final T2 t2, GivenLater _2, GivenLater _3) {
