...
public final class Compare_ implements java.io.Serializable {
    ...
    public static final <S, T extends java.lang.Comparable<T>> fi.solita.utils.functional.Function1<fi.solita.utils.functional.Function1<? super S,fi.solita.utils.functional.Option<T>>, fi.solita.utils.functional.Ordering<S>> byOption() { return new fi.solita.utils.functional.Function1<fi.solita.utils.functional.Function1<? super S,fi.solita.utils.functional.Option<T>>, fi.solita.utils.functional.Ordering<S>>() {
    ...
    public static final <S, T> fi.solita.utils.functional.Function2<fi.solita.utils.functional.Function1<? super S,fi.solita.utils.functional.Option<T>>, java.util.Comparator<? super T>, fi.solita.utils.functional.Ordering<S>> byOption1() { return new fi.solita.utils.functional.Function2<fi.solita.utils.functional.Function1<? super S,fi.solita.utils.functional.Option<T>>, java.util.Comparator<? super T>, fi.solita.utils.functional.Ordering<S>>() {
    ...
    public static final <T> fi.solita.utils.functional.Function0<fi.solita.utils.functional.Ordering<fi.solita.utils.functional.Option<T>>> optionOrdering() { return new fi.solita.utils.functional.Function0<fi.solita.utils.functional.Ordering<fi.solita.utils.functional.Option<T>>>() {
        public fi.solita.utils.functional.Ordering<fi.solita.utils.functional.Option<T>> apply() {
            return fi.solita.utils.functional.Compare.<T>optionOrdering();
        }
    };
    }
